...
![image-20210616221635160](http://oss.jianzhang.site/images/20240616221743.png)

网卡2：

![image-20210616221701407](http://oss.jianzhang.site/images/20240616221757.png)

![image-20210616225140704](http://oss.jianzhang.site/images/20240616221811.png)

ubuntu20.04 改成了使用 `netplan` 管理网络；配置文件在`/etc/netplan/*.yaml` 。

首先查看虚拟机中网卡名：

![image-20210616225045650](http://oss.jianzhang.site/images/20240616221829.png)
