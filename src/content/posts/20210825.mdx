...
![视频编解码IBP帧](http://oss.jianzhang.site/images/20240616210057.png)
...
![img](http://oss.jianzhang.site/images/20240616210138.png)
...
- 查看支持的文件格式
  ...
  ![image-20210824213540023](http://oss.jianzhang.site/images/20240616210201.png)
...
- 查看支持的编解码器
  ...
  ![image-20210824213749383](http://oss.jianzhang.site/images/20240616210249.png)

  ![image-20210824213833962](http://oss.jianzhang.site/images/20240616210320.png)
...
- 查看支持的滤镜
  ...
  ![image-20210824214223265](http://oss.jianzhang.site/images/20240616210343.png)

  ![image-20210824214351622](http://oss.jianzhang.site/images/20240616210406.png)
...
- 查看不同模块支持的参数
  ...
  ![image-20210824214853811](http://oss.jianzhang.site/images/20240616210429.png)
...
- 由文件切片和目录文件组成
  ...
  ![image-20210824224848188](http://oss.jianzhang.site/images/20240616211228.png)
...
- ffconcat格式索引
  ...
  ![image-20210824230227093](http://oss.jianzhang.site/images/20240616211301.png)
...
- CSV格式索引
  ...
  ![image-20210824230330471](http://oss.jianzhang.site/images/20240616211322.png)
...
- NvidiaGPU
  ...
  ![Transcoding pipeline with ffmpeg flow diagram](http://oss.jianzhang.site/images/20240616211500.png)
...
![image-20210825000021734](http://oss.jianzhang.site/images/20240616211538.png)
...
![image-20210825000236380](http://oss.jianzhang.site/images/20240616211601.png)
...
![image-20210825000353733](http://oss.jianzhang.site/images/20240616211621.png)
...
![image-20210825000601957](http://oss.jianzhang.site/images/20240616211641.png)
...
![image-20210825000713474](http://oss.jianzhang.site/images/20240616211702.png)
...
![image-20210825000830194](http://oss.jianzhang.site/images/20240616211732.png)
...
- AVFormat
  ...
  ![image-20210825001527103](http://oss.jianzhang.site/images/20240616211844.png)

- AVCodec

  编解码模块

  ![image-20210825001548446](http://oss.jianzhang.site/images/20240616211917.png)
...
- AVFilter
  ...
  ![image-20210825001719927](http://oss.jianzhang.site/images/20240616212011.png)
...
![image-20210825193219696](http://oss.jianzhang.site/images/20240616212044.png)

### 解封装

> 注册模块->打开输入上下文->查找音视频流信息->循环读取视频包->关闭输入上下文

![image-20210825193322700](http://oss.jianzhang.site/images/20240616212105.png)

### 解码

> 注册模块->查找解码器->分配解码器上下文->打开解码器->发送数据包->循环读取完，解码后的数据帧->释放解码器上下文

![image-20210825193407945](http://oss.jianzhang.site/images/20240616212130.png)

编码跟解码类似

### 滤镜处理流程

![image-20210825193539778](http://oss.jianzhang.site/images/20240616212151.png)
